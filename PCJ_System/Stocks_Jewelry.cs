      ...
      /*  private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //  myForm.btnrefresh.Visible = false;
            //  myForm.btnsave.Visible = false;

            myForm.Stock_Type.Text = "Jewellery";

            myForm.txtstock_no.Text = this.dataGridView1.CurrentRow.Cells[0].Value.ToString();

            myForm.txt_qty.Text = this.dataGridView1.CurrentRow.Cells[1].Value.ToString();
            myForm.combo_itemk_description.Text = this.dataGridView1.CurrentRow.Cells[2].Value.ToString();

            myForm.txt_gem_type.Text = this.dataGridView1.CurrentRow.Cells[3].Value.ToString();
            myForm.txt_gem_weight.Text = this.dataGridView1.CurrentRow.Cells[4].Value.ToString();
            myForm.combo_item_type.Text = this.dataGridView1.CurrentRow.Cells[6].Value.ToString();
            myForm.txt_no_of_gems.Text = this.dataGridView1.CurrentRow.Cells[7].Value.ToString();
            myForm.txt_no_of_other_gems.Text = this.dataGridView1.CurrentRow.Cells[8].Value.ToString();
            myForm.txt_other_gems.Text = this.dataGridView1.CurrentRow.Cells[9].Value.ToString();
            myForm.txt_weight_of_other_gems.Text = this.dataGridView1.CurrentRow.Cells[10].Value.ToString();
            myForm.txt_cost.Text = this.dataGridView1.CurrentRow.Cells[12].Value.ToString();

            //  myForm.cmbStockType.Enabled = false;
            //  myForm.txtstock_no.Enabled = false;
            ...
            using (var cmd = new SqlCommand("SELECT Image FROM Stock_Entry WHERE Stock_ID=@Stock_ID AND Stock_No= @Stock_No", conn))
            {
                ...
                using (var Reader = cmd.ExecuteReader())
                {
                    ...
                    {
                        MemoryStream ms = new MemoryStream(Reader["Image"] as byte[]);
                        myForm.pb1.Image = Image.FromStream(ms);
                    }
